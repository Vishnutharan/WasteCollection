...
namespace cleanlanka_backend.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WasteRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WasteRequests_AspNetUsers_CitizenId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WasteRequests_CitizenId",
                table: "WasteRequests",
                column: "CitizenId");
        }
